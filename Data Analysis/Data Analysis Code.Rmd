...
ggplot(full_data_test, aes(x = gdpg, y = `Total Life Expectancy`)) +
  geom_point()
```

```{r full_life_expectancy_model}
...
sig_data_life_exp$spending2 <- full_data_test$spending^2
sig_data_life_exp$education2 <- full_data_test$education^2
...
full_data_test2$gdp2 <- full_data_test2$gdp^2
full_data_test2$income2 <- full_data_test2$income^2
full_data_test2$poverty2 <- full_data_test2$poverty^2
full_data_test2$education2 <- full_data_test2$`Educational attainment, at least completed upper secondary, population 25+, total (%) (cumulative)`^2
...
ggplot(full_data_test2, aes(x = education, y = mortality)) +
  geom_point()
```

```{r full_mortality_model}
