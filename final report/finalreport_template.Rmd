...
p_edu <- full_data %>%
  ggplot(aes(full_data$`Educational attainment, at least completed upper secondary, population 25+, total (%) (cumulative)`)) + 
  geom_histogram(fill = "blue", na.rm = TRUE, bins = 30) + 
  labs(
...
grid.arrange(p_log_the, p_log_gdp, p_gdpg, p_pov, p_inc, p_edu, rows = 2)
```
