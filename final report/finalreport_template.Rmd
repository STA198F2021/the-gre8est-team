...
```{r full_mortality_model_resid, warning = FALSE, echo = FALSE}
...
```{r sig_mortality_model_resid, warning = FALSE, echo = FALSE}
...
log(Mortality Rate Under the Age of 5) = (Roni adds equation and interpretation here)
