...
result1$term <- vals1
result1 <- result1[-c(3:4)]
result1 %>% kable(col.names = c("Term", "Value", "p-value", "CI Lower", "CI Higher"),
                  escape = FALSE,
                  digits = 6) %>%
...
result2$term <- vals2
result2 <- result2[-c(3:4)]
result2 %>% kable(col.names = c("Term", "Value", "p-value", "CI Lower", "CI Higher"),
                  escape = FALSE,
                  digits = 6) %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "hold_position")
...
result3$term <- vals3
result3 <- result3[-c(3:4)]
result3 %>% kable(col.names = c("Term", "Value", "p-value", "CI Lower", "CI Higher"),
                  escape = FALSE,
                  digits = 6) %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "hold_position")
...
result4$term <- vals4
result4 <- result4[-c(3:4)]
result4 %>% kable(col.names = c("Term", "Value", "p-value", "CI Lower", "CI Higher"),
                  escape = FALSE,
                  digits = 6) %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "hold_position")
...
result5$term <- vals5
result5 <- result5[-c(3:4)]
result5 %>% kable(col.names = c("Term", "Value", "p-value", "CI Lower", "CI Higher"),
                  escape = FALSE,
                  digits = 6) %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "hold_position")
