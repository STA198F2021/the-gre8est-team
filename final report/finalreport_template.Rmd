...
The R^2 for the life expectancy simple linear model is 0.8388933 which means that 0.8388933 of the variation in life expectancy is explained by the model. The adjusted R^2 for the life expectancy simple linear model is 0.8338587 which means that 0.8338587 of the variation in life expectancy is explained by the model, adjusting for the number of variables included. 

``` {r full_life_expectancy_model_resid, warning = FALSE, echo = FALSE}
...
Total Life Expectancy = 38.837594399 + 7.060190898[log(THE per capita in PPP dollars)] - 0.215246470[log(THE per capita in PPP dollars)]^2 - 0.131323652[GDP] - 0.083085644[Poverty headcount ratio] + 0.190683904[Educational attainment] - 0.002025324[Educational attainment]^2
...
```{r sig_life_expectancy_model_table_resid, warning = FALSE, echo = FALSE}
...
Total Life Expectancy = (Roni adds equation and interpretation here)
...
```{r mixed_life_expectancy_model_resid, warning = FALSE, echo = FALSE}
